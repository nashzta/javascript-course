...
//     const status = dogAge >= 3 ? 'adulto' : 'cachorro';
//     console.log(`El perro número ${i + 1} es ${status} y tiene ${dogAge} años`);
//   });
// };
...
/* const numDeposits100 = accounts
  .flatMap(acc => acc.movements)
  .reduce((count, mov, i, arr) => (mov >= 1000 ? ++count : count), 0);
